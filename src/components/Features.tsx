...
const comparisonData = [
  { featureKey: 'comparisonStack', ram: 'WinForms C# (.NET)', nexo: 'Electron + React + TS' },
  { featureKey: 'comparisonPlatform', ram: 'Solo Windows', nexo: 'Windows (Mac/Linux futuro)' },
  { featureKey: 'comparisonUi', ram: 'UI básica de 2015', nexo: 'Design system moderno, glassmorphism' },
  { featureKey: 'comparisonEncryption', ram: 'Básico', nexo: 'AES-256-GCM derivado del hardware' },
  { featureKey: 'comparisonMulti', ram: 'Sí', nexo: 'Sí, mejor integrado' },
  { featureKey: 'comparisonServer', ram: 'Lista básica', nexo: 'Con región, ping y filtros' },
  { featureKey: 'comparisonSupport', ram: 'Abandonado', nexo: 'Soporte activo por SaaS' },
];
...
export default function Features() {
  ...
  const featureItems = [
    { icon: 'lock', titleKey: 'item1Title', descKey: 'item1Desc' },
    { icon: 'multi', titleKey: 'item2Title', descKey: 'item2Desc' },
    { icon: 'api', titleKey: 'item3Title', descKey: 'item3Desc' },
    { icon: 'import', titleKey: 'item4Title', descKey: 'item4Desc' },
    { icon: 'refresh', titleKey: 'item5Title', descKey: 'item5Desc' },
    { icon: 'server', titleKey: 'item6Title', descKey: 'item6Desc' },
  ];
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left py-3 px-4 text-text-secondary font-medium">{t('comparisonFeature')}</th>
                  <th className="text-left py-3 px-4 text-text-secondary font-medium">{t('comparisonRam')}</th>
                  <th className="text-left py-3 px-4 text-primary font-medium">{t('comparisonNexo')}</th>
                </tr>
              </thead>
              <tbody>
                {comparisonData.map((row, index) => (
                  <tr
                    ...
                    style={{ transitionDelay: `${index * 100}ms` }}
                  >
                    <td className="py-3 px-4 font-medium">{t(row.featureKey)}</td>
